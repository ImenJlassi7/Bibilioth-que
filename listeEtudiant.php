...
<body>
    ...
    <div cclass='container' style='min-height: 100vh; display: flex; justify-content: center; align-items: center; flex-direction: column; margin-top: -50px;'>
        <div class='box' style='width: 1000px;'>
            <h1 data-aos="fade-right">La liste des étudiants</h1>
...
<?php if (isset($_GET['success'])) { ?>
            ...
            <table class='table table-hover table-bordered custom-table'>
                ...
                foreach ($res as $row) {
                    ...
                    echo "<tr><td>" . $p->getCodeEtudiant() . "</td><td>" . $p->getNom() . "</td><td>" . $p->getPrenom() . "</td><td>" . $p->getAdresse() . "</td><td>" . $p->getClasse() . "</td></tr>    ";
                }
                ?>
            </table>
