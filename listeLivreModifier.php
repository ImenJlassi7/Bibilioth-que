...
<body>
    ...
    <div cclass='container' style='min-height: 100vh; display: flex; justify-content: center; align-items: center; flex-direction: column; margin-top: -50px;'>
        <div class='box' style='width: 1000px;'>
            <h1 data-aos="fade-right">Modifier Un livre</h1>
            ...
            <table class='table table-hover custom-table'>
                <thead class='thead-dark'>
                    <tr>
                        ...
                        <th scope='row' scope='col'>opérateurs</th>
                    </tr>
                </thead>
                <?php
                ...
                foreach ($res as $row) {
                    ...
                    echo "<tr><td>" . $p->getCodeLivre() . "</td><td>" . $p->getTitre() . "</td><td>" . $p->getAuteur() . "</td><td>" . $p->getDateEdition() . "</td><td><a class='btn btn-success' href='modifierLivreHtml.php?CodeLivre=" . $p->getCodeLivre() . "&amp;titre=" . $p->getTitre() . "&amp;auteur=" . $p->getAuteur() . "&amp;DateEdition=" . $p->getDateEdition() . "'>modifier   </td></tr>    ";
                }
                ?>
            </table>
        </div>
